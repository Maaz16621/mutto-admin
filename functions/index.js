...
/**
 * Cloud Function to send a push notification when a new message is added to a chat.
 * This triggers on document creation in the `messages` subcollection of any chat in the `chats` collection.
 */
